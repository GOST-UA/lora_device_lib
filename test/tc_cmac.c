...
static void test_LoraCMAC_mlen320_parts1(void **user)
{
    ...
    LoraAES_init(&aes_ctx, key);
    LoraCMAC_init(&cmac_ctx, &aes_ctx);
    LoraCMAC_update(&cmac_ctx, m, 8);
    LoraCMAC_update(&cmac_ctx, &m[8], sizeof(m)-8);
    LoraCMAC_finish(&cmac_ctx, out, sizeof(out));
...
static void test_LoraCMAC_mlen320_parts2(void **user)
{
    ...
    LoraAES_init(&aes_ctx, key);
    LoraCMAC_init(&cmac_ctx, &aes_ctx);
    LoraCMAC_update(&cmac_ctx, m, 16);
    LoraCMAC_update(&cmac_ctx, &m[16], sizeof(m)-16);
    LoraCMAC_finish(&cmac_ctx, out, sizeof(out));
...
static void test_LoraCMAC_mlen320_parts3(void **user)
{
    ...
    LoraAES_init(&aes_ctx, key);
    LoraCMAC_init(&cmac_ctx, &aes_ctx);
    LoraCMAC_update(&cmac_ctx, m, 17);
    LoraCMAC_update(&cmac_ctx, &m[17], sizeof(m)-17);
    LoraCMAC_finish(&cmac_ctx, out, sizeof(out));
